...
cocktails = {
    ...
    Orange_Whip: { tags: [36 , 15, 22 ,28, 20] , description: "Gin, Egg Whites, Orange Curacao, Orange Juice, Sugar", name: "Orange Whip", image_url: "https://s-media-cache-ak0.pinimg.com/736x/00/32/05/0032059b5e187bc63204d4d7069012d4.jpg"},

    Trinidad_Sour: { tags: [36 ,14, 17, 27], description: "Rye Whiskey, Angostura Bitters, Lemon Juice, Orgeat", name: "Trinidad Sour", image_url: "http://www.squirrelfarts.com/sfblog/wp-content/uploads/2012/07/rule37trinidadsour.jpg"} ,

    Negroni: { tags: [ 7, 1, 9, 11], description: "Gin, Campari, Sweet Vermouth", name: "Negroni", image_url: "http://graphics8.nytimes.com/images/2013/12/30/t-magazine/30spagliato-rowan1/30spagliato-rowan1-tmagArticle.jpg"} ,

    Americano: { tags: [36 ,2 , 17], description: "Campari, Sweet Vermouth, Soda Water", name: "Americano", image_url: "http://cf.ltkcdn.net/cocktails/images/std/178410-230x307-Americano-drink-IS.jpg"} ,

    Ephemeral: { tags: [ 7, 1, 8], description: "Gin, Dolin Blanc, St Germain, Celery Bitters", name: "Ephemeral", image_url: "http://3.bp.blogspot.com/-pILVIwU8Hfs/VbTk1vaqGYI/AAAAAAAAOMg/JBBzN8akTvQ/s1600/Ephemeral%2Bcocktail.jpg"} ,

    Martinez: { tags: [ 6, 1, 2], description: "Old Tom Gin, Sweet Vermouth, Luxardo, Angostura Bitters, Regan's Orange Bitters", name: "Martinez", image_url: "http://punchdrink.com/wp-content/uploads/2013/12/Martinez.jpg"} ,

    Cucumber_Cooler: { tags: [15, 20, 23, 30, 36], description: "Gin, Aperol, Lime Juice, Sugar, Soda Water", name: "Cucumber Cooler", image_url: "http://images.tastespotting.com/uploads/thumbnail/496534.jpg"} ,

    Gin_Gin_Mule: { tags: [ 20, 36, 23, 15, 30], description: "Gin, Lime Juice, Sugar, Ginger Beer", name: "Gin Gin Mule", image_url: "http://summitsips.com/wp-content/uploads/2011/05/IMG_1901.jpg"} ,

    Favela: { tags: [ 36, 2, 17], description: "Gin, Cocchi Americano, Campari, Falernum, Lemon Juice, Grapefruit Bitters", name: "Favela", image_url: "https://putneyfarm.files.wordpress.com/2013/03/plane6.jpg"} ,

    Royal_Hawaiian: { tags: [36 ,20, 22, 28, 15], description: "Gin, Pineapple Juice, Orgeat, Lemon Juice", name: "Royal Hawaiian", image_url: "https://s-media-cache-ak0.pinimg.com/236x/43/00/97/43009757583753eac9464f082c412c36.jpg"} ,

    Penicillin: { tags: [ 36, 14, 19], description: "Scothc, Ginger, Honey, Lemon", name: "Penicillin", image_url: "http://www.snackish.com/wp-content/uploads/2012/03/penicillin_cocktail_recipe.jpg"} ,

    Unlucky_Italian: { tags: [36, 17, 14], description: "Cynar, Averna, Honey, Cinnamon, Lemon Juice, Egg White", name: "Unlucky Italian", image_url: "https://s-media-cache-ak0.pinimg.com/236x/ac/5e/92/ac5e92fa4e875d7c1c88563c22ba14e6.jpg"} ,

    Jack_Rose: { tags: [ 21, 36, 25, 15, 32, 35], description: "Apple Brandy, Lemon Juice, Grenadine", name: "Jack Rose", image_url: "https://daddyosmartinis.files.wordpress.com/2015/02/jack-rose-cocktail.jpg"},

    Chocolate_Flip: { tags: [36, 15, 21, 24], description: "Dark Rum, Tia Maria, Whole Egg, Sugar", name: "Chocolate Flip", image_url: "http://punchdrink.com/wp-content/uploads/2016/03/Article-Flip-Cocktail-Ale-Sherry-Brandy-Drinks-History-Recipe-Elephant-Flip-Pouring-Ribbons-Franklin-Bar-Philadelphia-NYC.jpg"},

    Jim_Jam: { tags: [36, 15, 21, 25, 32, 34], description: "Averna, Apry, Lemon Juice", name: "Jim Jam", image_url: "http://www.miami.com/sites/migration.miami.com/files/images/summerjam.jpg"}
